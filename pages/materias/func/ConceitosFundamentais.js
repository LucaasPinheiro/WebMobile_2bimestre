...
export default function ConceitosFundamentais() {
  return (
    <Layout title="Conceitos Fundamentais - EducaMat">
      
      {/* Conteúdo da Matéria */}
      <div className="container mt-5">
        <h1 className="text-center mb-4">Conceitos Fundamentais</h1>
        <div className="row justify-content-center mb-5">
          ...
          <div className="col-md-6">
            ...
            <div className="row row-cols-1 g-4">
              ...
              <div className="col">
                <a 
                  href="https://matematiques.com.br/ensino-medio/funcoes/funcao-o-que-e-tipos-e-classificacao/" 
                  target="_blank" 
          ...
          <div className="col-md-6 d-flex flex-column align-items-center">
            ...
            <div className="mb-4 w-100" style={{ maxWidth: '350px' }}>
              <div className="position-relative">
                <a 
                  href="https://www.youtube.com/watch?v=SPZqQ5qn3P0&list=PLTPg64KdGgYiYqKmotPzPJVchCwKpTLzm&index=1" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="d-block"
                >
                  <img 
                    src="https://img.youtube.com/vi/SPZqQ5qn3P0/hqdefault.jpg" 
