...
export default function Funcao1Grau() {
  return (
    <Layout title="Função 1 Grau - EducaMat">
      
      {/* Conteúdo da Matéria */}
      <div className="container mt-5">
        <h1 className="text-center mb-4">Funcao de 1º Grau</h1>
        <div className="row justify-content-center mb-5">
          ...
          <div className="col-md-6">
            ...
            <div className="row row-cols-1 g-4">
              ...
              <div className="col">
                <a 
                  href="https://matematiques.com.br/ensino-medio/funcoes/funcao-de-1-grau-forma-geral-e-grafico/" 
                  target="_blank" 
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/bb93w732" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">Função de 1º grau</h5>
                      <p className="card-text">Clique para acessar o material</p>
                    </div>
                  </div>
                </a>
          ...
          <div className="col-md-6 d-flex flex-column align-items-center">
            ...
            <div className="mb-4 w-100" style={{ maxWidth: '350px' }}>
              <div className="position-relative">
                <a 
                  href="https://www.youtube.com/watch?v=R8UZRBFWJXY" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="d-block"
                >
                  <img 
                    src="https://img.youtube.com/vi/R8UZRBFWJXY/hqdefault.jpg" 
