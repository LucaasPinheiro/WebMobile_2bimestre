...
export default function Semelhanca() {
  return (
    <Layout title="Semelhança de triângulos - EducaMat">
      
      {/* Conteúdo da Matéria */}
      <div className="container mt-5">
        <h1 className="text-center mb-4">Semelhança de triângulos</h1>
        <div className="row justify-content-center mb-5">
          ...
          <div className="col-md-6">
            ...
            <div className="row row-cols-1 g-4">
              ...
              <div className="col">
                <a 
                  href="https://beduka.com/blog/materias/matematica/semelhanca-de-triangulos/" 
                  target="_blank" 
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/nty9szh6" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">Semelhança de Triângulos</h5>
                      <p className="card-text">Clique para acessar o material</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/NvHg5sm2" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
          ...
          <div className="col-md-6 d-flex flex-column align-items-center">
            ...
            <div className="mb-4 w-100" style={{ maxWidth: '350px' }}>
              <div className="position-relative">
                <a 
                  href="https://www.youtube.com/watch?v=LxFlnxS6iMg" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="d-block"
                >
                  <img 
                    src="https://img.youtube.com/vi/LxFlnxS6iMg/hqdefault.jpg" 
