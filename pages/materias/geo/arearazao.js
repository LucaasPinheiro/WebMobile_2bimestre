...
export default function AreaRazao() {
  return (
    <Layout title="Área e razão entre figuras planas - EducaMat">
      
      {/* Conteúdo da Matéria */}
      <div className="container mt-5">
        <h1 className="text-center mb-4">Área e razão entre figuras planas</h1>
        <div className="row justify-content-center mb-5">
          ...
          <div className="col-md-6">
            ...
            <div className="row row-cols-1 g-4">
              ...
              <div className="col">
                <a 
                  href="https://matematicahoje.blog/area-de-figuras-planas-como-calcular-exercicios-resolvidos/" 
                  target="_blank" 
              ...
              <div className="col">
                <a 
                  href="https://promilitares.com.br/concursos-militares/conteudo/figuras-equivalentes-e-razao-entre-areas/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/shd8kxex" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">Área de Figuras Planas</h5>
                      <p className="card-text">Clique para acessar o material</p>
                    </div>
                  </div>
                </a>
          ...
          <div className="col-md-6 d-flex flex-column align-items-center">
            <h3 className="text-center mb-4">Universo Narrado</h3>
            
            {/* Vídeo 1 */}
            <div className="mb-4 w-100" style={{ maxWidth: '350px' }}>
              <div className="position-relative">
                <a 
                  href="https://www.youtube.com/watch?v=SLEFCrrVujk" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="d-block"
                >
                  <img 
                    src="https://img.youtube.com/vi/SLEFCrrVujk/hqdefault.jpg" 
