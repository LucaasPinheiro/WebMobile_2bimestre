...
export default function Porcentagem() {
  return (
    <Layout title="Porcentagem - EducaMat">
      
      {/* Conteúdo da Matéria */}
      <div className="container mt-5">
        <h1 className="text-center mb-4">Porcentagem</h1>
        <div className="row justify-content-center mb-5">
          ...
          <div className="col-md-6">
            ...
            <div className="row row-cols-1 g-4">
              ...
              <div className="col">
                <a 
                  href="https://matematiques.com.br/ensino-fundamental/conceitos-basicos-da-matematica/porcentagem-o-que-e-representacoes-e-como-utilizar/" 
                  target="_blank" 
                ...
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">O que é, representações e como utilizar:</h5>
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/dgdtxwcr" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">Calculando porcentagem</h5>
                      <p className="card-text">Clique para acessar o material</p>
                    </div>
                  </div>
                </a>
              ...
              <div className="col">
                <a 
                  href="https://www.geogebra.org/m/y4pcuph9" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-decoration-none text-dark"
                >
                  <div className="card h-100 card-hover">
                    <div className="card-body text-center">
                      <h5 className="card-title">Atividades porcentagem</h5>
                      <p className="card-text">Clique para acessar o material</p>
                    </div>
                  </div>
                </a>
          ...
          <div className="col-md-6 d-flex flex-column align-items-center">
            ...
            <div className="mb-4 w-100" style={{ maxWidth: '350px' }}>
              <div className="position-relative">
                <a 
                  href="https://www.youtube.com/watch?v=CERiIwParX4" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="d-block"
                >
                  <img 
                    src="https://img.youtube.com/vi/CERiIwParX4/hqdefault.jpg" 
