  ...
  return (
    <>
      ...
      <div className="container py-5">
        <h1 className="mb-4 text-center">Recursos e Plataformas de Matemática</h1>
        
        {/* Calculadoras */}
        <div className="mb-5">
          <h3>🧮 Calculadoras e Conversores</h3>
          <ul className="list-group">
            <li className="list-group-item">
              <a href="https://www.exploratorium.edu/ronh/age/" target="_blank" rel="noopener noreferrer">
                Calculadora de idade em outros planetas – Exploratorium
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.convertworld.com/pt/numerais/" target="_blank" rel="noopener noreferrer">
                Conversor de bases numéricas – ConvertWorld
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://pt.numberempire.com/primenumbers.php" target="_blank" rel="noopener noreferrer">
                Identificador de números primos – Number Empire
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.mathsisfun.com/data/quincunx.html" target="_blank" rel="noopener noreferrer">
                Tábua de Galton (Quincunx) – Maths is Fun
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.geogebra.org/3d" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mb-5">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              <a href="https://www.youtube.com/channel/UCbEiPECXvNKtaa4dUBRUh1w" target="_blank" rel="noopener noreferrer">
                Origamis – Canal Easy Origami no YouTube
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-5">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              <a href="https://matematicavirtual.mast.br/africa-jogos-ancestrais/" target="_blank" rel="noopener noreferrer">
                África – Exposição Virtual de Jogos Ancestrais (Museu da Matemática UFMG)
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-5">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              <a href="https://phet.colorado.edu/pt_BR/" target="_blank" rel="noopener noreferrer">
                PhET – Simulações interativas
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.ties-education.org/" target="_blank" rel="noopener noreferrer">
                TIES Education
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.bcb.gov.br/cidadaniafinanceira/" target="_blank" rel="noopener noreferrer">
                Cidadania Financeira – Banco Central
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://pmo.sbm.org.br/" target="_blank" rel="noopener noreferrer">
                Olimpíada de Matemática da SBM (PMO)
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://rpm.org.br/default.aspx?m_id=1" target="_blank" rel="noopener noreferrer">
                Revista do Professor de Matemática (SBM)
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://lablivre.tec.br/" target="_blank" rel="noopener noreferrer">
                LabLivre – Laboratório de Tecnologias Livres
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://www.ifsp.edu.br/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mb-5">
          ...
          <ul className="list-group">
            <li className="list-group-item">
              <a href="https://m3.ime.unicamp.br/" target="_blank" rel="noopener noreferrer">
                Matemática Multimídia (IFSP)
              </a>
            </li>
            <li className="list-group-item">
              <a href="https://id.trimble.com/" target="_blank" rel="noopener noreferrer">
                Trimble Identity
              </a>
            </li>
          </ul>
